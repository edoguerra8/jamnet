...
export const TRACK_COLUMNS =
  'id, mb_recording_id, title, artist_name, artist_mb_id, artwork_url, apple_music_id, youtube_video_id, itunes_preview_url, is_new_release, year, country, macro_area, tags, weight, quality_score, track_listeners'
